...
const availableWidgets = [
  ...
  { type: 'time', title: 'Tidrapportering', description: 'Tidsrapportering för veckan' },
  { type: 'assigned', title: 'Tilldelat mig', description: 'Uppgifter tilldelade till mig' },
]
...
const defaultLayout = [
  ...
  {x: 0, y: 10, w: 4, h: 7, i: 'recently', type: 'recently', static: false},
]
